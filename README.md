...
class MohammedRiyaz:
    ...
    def current_obsessions(self):
        return ["system design", "cloud cost optimisation", "developer tooling", "LLM agents"]

    def ask_me_about(self):
        return ["backend architecture", "cloud infra", "startups", "system design"]
    ...
    def philosophy(self):
        return "Ship fast. Scale smart. Fix bugs quietly."
```
...
![AWS Bedrock](https://img.shields.io/badge/AWS_Bedrock-8C4FFF?style=for-the-badge&logo=amazonaws&logoColor=white)
